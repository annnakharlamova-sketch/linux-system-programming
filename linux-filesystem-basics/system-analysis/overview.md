...
This section contains practical analysis of Linux system directories and virtual filesystems.

## Covered Areas

- `/var/log`: log files analysis, file size inspection, recent changes, error search
